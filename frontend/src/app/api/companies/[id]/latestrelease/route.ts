...
export async function GET(req:NextRequest,{params}:{params:{id:string}}){
    ...
    if(from_date!=null && to_date == null){
        releaselist_url = 'https://hackathon.stg-prtimes.net/api/companies/'+company_id+'/releases?from_date='+from_date;
    }else if(from_date == null && to_date != null){
        releaselist_url = 'https://hackathon.stg-prtimes.net/api/companies/'+company_id+'/releases?to_date='+to_date;
    }else if(from_date != null && to_date != null){
        releaselist_url = 'https://hackathon.stg-prtimes.net/api/companies/'+company_id+'/releases?from_date='+from_date+'&to_date='+to_date;
    }else{
        releaselist_url = 'https://hackathon.stg-prtimes.net/api/companies/'+company_id+'/releases';
    }
