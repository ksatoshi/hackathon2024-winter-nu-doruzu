  ...
  return (
    <form className="max-w-md mx-auto my-3" onSubmit={(e) => handleSubmit(e)}>
      ...
      <div className="relative">
        ...
        <button
          type="submit"
          className="absolute inset-y-0 right-0 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3.5 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Search
        </button>
      </div>
